...
def test_blind_auth_renderer_asserts_public_written_state(tmp_path: Path):
...
""",
    ...
    experiment = Experiment(
        ...
        target_function="setWhitelist",
    )
    # Use a matching hypothesis/experiment pair for the generic renderer.
