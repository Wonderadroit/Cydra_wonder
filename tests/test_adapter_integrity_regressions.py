...
def test_receive_and_fallback_keep_distinct_ast_kinds_when_state_evidence_exists():
    ast = {"nodeType": "SourceUnit", "nodes": [
        {"nodeType": "ContractDefinition", "id": 1, "name": "C", "nodes": [
            ...
            {"nodeType": "FunctionDefinition", "id": 2, "name": "", "kind": "receive", "scope": 1, "body": {"nodeType": "Block", "statements": [{"nodeType": "Identifier", "id": 20, "referencedDeclaration": 10}]}},
            {"nodeType": "FunctionDefinition", "id": 3, "name": "", "kind": "fallback", "scope": 1, "body": {"nodeType": "Block", "statements": [{"nodeType": "Identifier", "id": 30, "referencedDeclaration": 10}]}},
        ]
    ]}
