...
def build(support=True):
    ...
    if support: model.add_edge(__import__("cydra.system_model",fromlist=["Edge"]).Edge("evidence:e1","supports","hypothesis:h1"))
...
def test_impact_assessment_unknown_blocks_readiness():
