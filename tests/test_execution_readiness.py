...
def test_readiness_resolves_library_from_aggregate_import(tmp_path):
    lib = tmp_path / "Errors.sol"
    lib.write_text("library FirstErrors { error Nope(); } library LendingPoolErrors { error AuctionOngoing(); }", encoding="utf-8")
    source = tmp_path / "Target.sol"
    source.write_text('import { LendingPoolErrors } from "./Errors.sol"; contract Target {}', encoding="utf-8")
    function = FunctionModel("configure", "external", (), (), (("LendingPoolErrors", "AuctionOngoing"),), 1)
