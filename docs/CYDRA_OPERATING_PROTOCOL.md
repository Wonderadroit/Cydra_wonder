...
A real finding requires reproducible evidence and must survive adversarial challenge. Compiler-backed state-effect evidence may inform prerequisite-transition discovery, but it never substitutes for executing and verifying that transition.
