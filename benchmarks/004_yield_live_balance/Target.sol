...
/// Minimal protocol-level reconstruction of the vulnerable Yield Strategy accounting shape.
contract StrategyVulnerable {
    ...
    function burn(address to) external returns (uint256 poolTokensObtained) {
        ...
        // Vulnerable: unsolicited donations change the redemption price.
